# F23: Sequences: Sequences: Polynomial Fitting and Difference Tests
...
* Don't try to apply polynomial fitting to find the coefficients as it is too messy for this one,

## Problem 2
Let $s_0, s_1, ...$ be 1 3 6 10 15 21 28  ..
Find the degree of the polynomial
and use polynomial fitting to find a closed form ...
