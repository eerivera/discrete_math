...
## Sample Problems
**Exerise 0**
* The nonnegative even numbers correspond to the sequence $a_0,a_1,a_2,\ldots$ where $a_i = 2i$, producing $0,2,4,6,\ldots$. What is the formula for $a_i$ defining the positive even numbers $2,4,6,8,10,\ldots$ when the sequence is indexed starting at $a_0$?
...
$$\frac{a}{x-7} + \frac{b}{x+6} = \frac{x+1}{x^2-x-42}$$
