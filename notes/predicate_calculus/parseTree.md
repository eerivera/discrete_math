...
In this course, use the [dot convention](overview.md#dot-notation-and-quantifier-scope): write a dot after each quantified variable. The quantifier's scope extends to the end of the formula unless a closing parenthesis enclosing the quantifier ends it sooner. Use parentheses to restrict scope and to clarify the grouping of mixed binary operators.
